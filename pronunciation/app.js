...
const SENTENCES = [
  {
    ...
    label: "Sentence 1",
    original:
      "В четверг четвёртого числа в четыре с четвертью часа лигурийский регулировщик регулировал в Лигурии, но тридцать три корабля лавировали, лавировали, да так и не вылавировали.",
    chunkIds: ["s0-c1", "s0-c2", "s0-c3", "s0-c4"],
  },
  {
    id: "s1",
    label: "Sentence 2",
...
const CHUNKS = [
  {
    ...
    sentenceId: "s0",
    chunkIndex: 1,
    russian: "В четверг четвёртого числа в четыре с четвертью часа",
    syllabified: "В че-тве-рг че-твё-рто-го чи-сла в че-ты-ре с че-твер-тью ча-са",
    english: "On Thursday the fourth, at a quarter past four,",
  },
  {
    id: "s0-c2",
    sentenceId: "s0",
    chunkIndex: 2,
    russian: "лигурийский регулировщик регулировал в Лигурии,",
    syllabified: "ли-гу-ри-йский ре-гу-ли-ро-вщик ре-гу-ли-ро-вал в Ли-гу-ри-и,",
    english: "the Ligurian traffic controller directed traffic in Liguria,",
  },
  {
    id: "s0-c3",
    sentenceId: "s0",
    chunkIndex: 3,
    russian: "но тридцать три корабля лавировали, лавировали,",
    syllabified: "но три-дцать три ко-ра-бля ла-ви-ро-ва-ли, ла-ви-ро-ва-ли,",
    english: "but thirty-three ships kept tacking and tacking,",
  },
  {
    id: "s0-c4",
    sentenceId: "s0",
    chunkIndex: 4,
    russian: "да так и не вылавировали.",
    syllabified: "да так и не вы-ла-ви-ро-ва-ли.",
    english: "and still never managed to tack their way through.",
  },
  {
    id: "s1-c1",
    sentenceId: "s1",
...
const CHUNK_PHRASE_DATA = {
  "s0-c1": {
    phrases: ["В четверг четвёртого числа", "в четыре с четвертью часа"],
    syllablePhrases: ["В че-тве-рг че-твё-рто-го чи-сла", "в че-ты-ре с че-твер-тью ча-са"],
  },
  "s0-c2": {
    phrases: ["лигурийский регулировщик", "регулировал в Лигурии,"],
    syllablePhrases: ["ли-гу-ри-йский ре-гу-ли-ро-вщик", "ре-гу-ли-ро-вал в Ли-гу-ри-и,"],
  },
  "s0-c3": {
    phrases: ["но тридцать три корабля", "лавировали, лавировали,"],
    syllablePhrases: ["но три-дцать три ко-ра-бля", "ла-ви-ро-ва-ли, ла-ви-ро-ва-ли,"],
  },
  "s0-c4": {
    phrases: ["да так и не", "вылавировали."],
    syllablePhrases: ["да так и не", "вы-ла-ви-ро-ва-ли."],
  },
  "s1-c1": {

  ...
  overlay.innerHTML = `
    <div class="session-summary-card">
      ...
      <div class="summary-stats">
        ...
        <div class="summary-stat"><strong>${steady}/${items.length}</strong><span>steady</span></div>
      </div>
      <p class="summary-note">${accuracy >= 85 ? "Strong session. Keep going or take a break." : accuracy >= 65 ? "Solid progress. Consider slowing down on weak items." : "Lots of misses. A short break might help consolidation."}</p>
